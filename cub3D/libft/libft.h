...
# include <ctype.h> 	// for isalpha, isdigit, isalnum, isascii, isprint, etc.
...
/*This function checks that the input character string is all digits.
...
/*The ft_strndup() function allocates sufficient memory for a copy of the 
...
/*The ft_string_add function adds a string to an array of strings.*/
char	**ft_string_add(char **array, char *str);

/*The ft_string_len function returns the length of a string array.*/
...
/*The ft_string_new function creates a new string.*/
...
/*	This function concatenates two strings and frees the memory of the original
	...
	string. This helps to avoid memory leaks when working with dynamically
	allocated strings and ensures that the original strings are freed correctly.
	*/
