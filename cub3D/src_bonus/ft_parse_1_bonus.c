...
/*   Created: 2024-12-29 10:15:34 by sternero          #+#    #+#             */
/*   Updated: 2024-12-29 10:15:34 by sternero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_parse(char *cub, t_data *info)
{
	...
	if (fd < 0)
	{
		printf(RED"Error opening the map file.\n"RESET);
		return (FAILURE);
	}
...
void	ft_missing_id(t_data *info, int *fd, int i)
{
	...
	if (info->textures.do_flag != 1)
		printf(RED"\"DO\" identifier is missing\n"RESET);
}
