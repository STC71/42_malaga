...
// # include "minishell.h" // Removed to avoid circular dependency
# include <fcntl.h>
...
// Enum for AST node types (bonus feature)
// NODE_CMD: simple command or pipeline
// NODE_AND: logical AND (&&)
// NODE_OR: logical OR (||)
// NODE_SEQ: sequential execution (;)
// NODE_SUBSHELL: command group in parentheses
...
// AST node structure for bonus features (&&, ||, parentheses)
// type: type of node
// cmds: array of commands (for NODE_CMD)
// left/right: child nodes for binary operators
// raw_cmd: raw command string
