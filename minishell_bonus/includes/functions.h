...
/* registration via atexit was removed to avoid globals */
...
int		duplicate_env(t_shell *shell, char **envp);
int		handle_minishell_test(t_shell *shell);
...
/* Registry internals remain private; do not declare globals here. */
...
// ------- Logical Operators Functions (Bonus) ------------------------------ //
